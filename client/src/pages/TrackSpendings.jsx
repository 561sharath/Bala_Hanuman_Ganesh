...
import { PiggyBank, Loader2, Calendar, Save, Search, User, Wallet } from 'lucide-react';
...
export const TrackSpendings = () => {
  ...
  }, [searchQuery, selectedDate, spentByQuery, activeTab, loadSpendingsList]);
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-4 sm:py-8">
      ...
      {isAdmin ? (
        /* Admin Create Spending Form */
        <div className="bg-[#161816]/95 backdrop-blur-xl border border-tertiary/40 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden max-w-3xl">
        ...
        /* Normal User Read-Only Spending List */
